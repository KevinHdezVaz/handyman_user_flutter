...
const APP_NAME = 'Kangu';
const APP_NAME_TAG_LINE = 'Kangu - Servicio de niñeras';
var defaultPrimaryColor = Color.fromARGB(255, 242, 162, 92);
 
const DOMAIN_URL = 'https://app.kavemx.com'; // Don't add slash at the end of the url
...
const DASHBOARD_AUTO_SLIDER_SECOND = 6;
